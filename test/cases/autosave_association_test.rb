...
require 'fixtures/bird'
class TestAutosaveAssociationsInGeneral < ActiveSupport::TestCase
  ActiveResource::HttpMock.respond_to do |mock|
    mock.post    "/people.json",               {}, {person: { id: 1 }}.to_json
    mock.post    "/references.json", {}, {}.to_json
  end

  def test_autosave_validation
    person = Class.new(ActiveResource::Base) {
    ...
    reference = Class.new(ActiveResource::Base) {
      self.site = "http://localhost/"
...
class TestDefaultAutosaveAssociationOnAHasOneAssociation < ActiveSupport::TestCase
...
class TestDefaultAutosaveAssociationOnABelongsToAssociation < ActiveSupport::TestCase
...
class TestDefaultAutosaveAssociationOnAHasManyAssociationWithAcceptsNestedAttributes < ActiveSupport::TestCase
...
class TestDefaultAutosaveAssociationOnAHasManyAssociation < ActiveSupport::TestCase
...
class TestDefaultAutosaveAssociationOnNewRecord < ActiveSupport::TestCase
...
class TestAutosaveAssociationOnAHasOneAssociation < ActiveSupport::TestCase

  def setup
    super
    ActiveResource::HttpMock.respond_to do |mock|
      mock.post "/pirates.json", {}, {id: 1, catchprase: "xyz"}.to_json
      mock.post "/ships.json", {}, {id: 1, name: "Nights Dirty Lightning"}.to_json
      mock.get "/pirates/1/ship.json", {}, nil, 404
    end
...
class TestAutosaveAssociationOnABelongsToAssociation < ActiveSupport::TestCase
...
class TestAutosaveAssociationOnAHasManyAssociation < ActiveSupport::TestCase
...
class TestAutosaveAssociationOnAHasAndBelongsToManyAssociation < ActiveSupport::TestCase
...
class TestAutosaveAssociationOnAHasAndBelongsToManyAssociationWithAcceptsNestedAttributes < ActiveSupport::TestCase
...
class TestAutosaveAssociationValidationsOnAHasManyAssociation < ActiveSupport::TestCase
...
class TestAutosaveAssociationValidationsOnAHasOneAssociation < ActiveSupport::TestCase
...
class TestAutosaveAssociationValidationsOnABelongsToAssociation < ActiveSupport::TestCase
...
class TestAutosaveAssociationValidationsOnAHABTMAssociation < ActiveSupport::TestCase
...
class TestAutosaveAssociationValidationMethodsGeneration < ActiveSupport::TestCase
...
class TestAutosaveAssociationWithTouch < ActiveSupport::TestCase
